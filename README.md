About boltzmannclean-feedstock
==============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/boltzmannclean-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8827&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/boltzmannclean-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `boltzmannclean` can be installed with `conda`:
...
```
mamba install boltzmannclean
```

It is possible to list all of the versions of `boltzmannclean` available on your platform with `conda`:
...
```
mamba search boltzmannclean --channel conda-forge
```
...
mamba repoquery search boltzmannclean --channel conda-forge

# List packages depending on `boltzmannclean`:
mamba repoquery whoneeds boltzmannclean --channel conda-forge

# List dependencies of `boltzmannclean`:
mamba repoquery depends boltzmannclean --channel conda-forge
```
